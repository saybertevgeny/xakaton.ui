 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var eo,to,oo,io;const F=window,x=t=>{F.emitLitDebugLogEvents&&F.dispatchEvent(new CustomEvent("lit-debug",{detail:t}))};let Ir=0,$t;(eo=F.litIssuedWarnings)!==null&&eo!==void 0||(F.litIssuedWarnings=new Set),$t=(t,e)=>{e+=t?` See https://lit.dev/msg/${t} for more information.`:"",F.litIssuedWarnings.has(e)||(console.warn(e),F.litIssuedWarnings.add(e))},$t("dev-mode","Lit is in dev mode. Not recommended for production!");const q=!((to=F.ShadyDOM)===null||to===void 0)&&to.inUse&&((oo=F.ShadyDOM)===null||oo===void 0?void 0:oo.noPatch)===!0?F.ShadyDOM.wrap:t=>t,De=F.trustedTypes,Si=De?De.createPolicy("lit-html",{createHTML:t=>t}):void 0,Pr=t=>t,Ut=(t,e,o)=>Pr,Or=t=>{if(Te!==Ut)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");Te=t},Lr=()=>{Te=Ut},ko=(t,e,o)=>Te(t,e,o),To="$lit$",se=`lit$${String(Math.random()).slice(9)}$`,bn="?"+se,zr=`<${bn}>`,Ce=document,Qe=()=>Ce.createComment(""),Ze=t=>t===null||typeof t!="object"&&typeof t!="function",xn=Array.isArray,Mr=t=>xn(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",no=`[ 	
\f\r]`,Vr=`[^ 	
\f\r"'\`<>=]`,Dr=`[^\\s"'>=/]`,We=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ci=1,ro=2,Ur=3,ki=/-->/g,Ti=/>/g,be=new RegExp(`>|${no}(?:(${Dr}+)(${no}*=${no}*(?:${Vr}|("|')|))|$)`,"g"),jr=0,$i=1,Fr=2,Ai=3,so=/'/g,ao=/"/g,_n=/^(?:script|style|textarea|title)$/i,Br=1,At=2,Do=1,Rt=2,Hr=3,qr=4,Wr=5,Uo=6,Gr=7,wn=t=>(e,...o)=>(e.some(i=>i===void 0)&&console.warn(`Some template strings are undefined.
This is probably caused by illegal octal escape sequences.`),{_$litType$:t,strings:e,values:o}),b=wn(Br),Oe=wn(At),ke=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),Ri=new WeakMap,we=Ce.createTreeWalker(Ce,129,null,!1);let Te=Ut;function En(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw")){let o="invalid template strings array";throw o=`
        ...
        `.trim().replace(/\n */g,`
`),new Error(o)}return Si!==void 0?Si.createHTML(e):e}const Kr=(t,e)=>{const o=t.length-1,i=[];let n=e===At?"<svg>":"",r,s=We;for(let a=0;a<o;a++){const d=t[a];let c=-1,m,h=0,y;for(;h<d.length&&(s.lastIndex=h,y=s.exec(d),y!==null);)if(h=s.lastIndex,s===We){if(y[Ci]==="!--")s=ki;else if(y[Ci]!==void 0)s=Ti;else if(y[ro]!==void 0)_n.test(y[ro])&&(r=new RegExp(`</${y[ro]}`,"g")),s=be;else if(y[Ur]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else s===be?y[jr]===">"?(s=r??We,c=-1):y[$i]===void 0?c=-2:(c=s.lastIndex-y[Fr].length,m=y[$i],s=y[Ai]===void 0?be:y[Ai]==='"'?ao:so):s===ao||s===so?s=be:s===ki||s===Ti?s=We:(s=be,r=void 0);console.assert(c===-1||s===be||s===so||s===ao,"unexpected parse state B");const ce=s===be&&t[a+1].startsWith("/>")?" ":"";n+=s===We?d+zr:c>=0?(i.push(m),d.slice(0,c)+To+d.slice(c)+se+ce):d+se+(c===-2?(i.push(void 0),a):ce)}const l=n+(t[o]||"<?>")+(e===At?"</svg>":"");return[En(t,l),i]};class et{constructor({strings:e,["_$litType$"]:o},i){this.parts=[];let n,r=0,s=0;const l=e.length-1,a=this.parts,[d,c]=Kr(e,o);if(this.el=et.createElement(d,i),we.currentNode=this.el.content,o===At){const m=this.el.content,h=m.firstChild;h.remove(),m.append(...h.childNodes)}for(;(n=we.nextNode())!==null&&a.length<l;){if(n.nodeType===1){{const m=n.localName;if(/^(?:textarea|template)$/i.test(m)&&n.innerHTML.includes(se)){const h=`Expressions are not supported inside \`${m}\` elements. See https://lit.dev/msg/expression-in-${m} for more information.`;if(m==="template")throw new Error(h);$t("",h)}}if(n.hasAttributes()){const m=[];for(const h of n.getAttributeNames())if(h.endsWith(To)||h.startsWith(se)){const y=c[s++];if(m.push(h),y!==void 0){const he=n.getAttribute(y.toLowerCase()+To).split(se),ne=/([.?@])?(.*)/.exec(y);a.push({type:Do,index:r,name:ne[2],strings:he,ctor:ne[1]==="."?Jr:ne[1]==="?"?Qr:ne[1]==="@"?Zr:jt})}else a.push({type:Uo,index:r})}for(const h of m)n.removeAttribute(h)}if(_n.test(n.tagName)){const m=n.textContent.split(se),h=m.length-1;if(h>0){n.textContent=De?De.emptyScript:"";for(let y=0;y<h;y++)n.append(m[y],Qe()),we.nextNode(),a.push({type:Rt,index:++r});n.append(m[h],Qe())}}}else if(n.nodeType===8)if(n.data===bn)a.push({type:Rt,index:r});else{let h=-1;for(;(h=n.data.indexOf(se,h+1))!==-1;)a.push({type:Gr,index:r}),h+=se.length-1}r++}x==null||x({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,o){const i=Ce.createElement("template");return i.innerHTML=e,i}}function Ue(t,e,o=t,i){var n,r,s,l;if(e===ke)return e;let a=i!==void 0?(n=o.__directives)===null||n===void 0?void 0:n[i]:o.__directive;const d=Ze(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==d&&((r=a==null?void 0:a._$notifyDirectiveConnectionChanged)===null||r===void 0||r.call(a,!1),d===void 0?a=void 0:(a=new d(t),a._$initialize(t,o,i)),i!==void 0?((s=(l=o).__directives)!==null&&s!==void 0?s:l.__directives=[])[i]=a:o.__directive=a),a!==void 0&&(e=Ue(t,a._$resolve(t,e.values),a,i)),e}class Yr{constructor(e,o){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=o}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){var o;const{el:{content:i},parts:n}=this._$template,r=((o=e==null?void 0:e.creationScope)!==null&&o!==void 0?o:Ce).importNode(i,!0);we.currentNode=r;let s=we.nextNode(),l=0,a=0,d=n[0];for(;d!==void 0;){if(l===d.index){let c;d.type===Rt?c=new st(s,s.nextSibling,this,e):d.type===Do?c=new d.ctor(s,d.name,d.strings,this,e):d.type===Uo&&(c=new es(s,this,e)),this._$parts.push(c),d=n[++a]}l!==(d==null?void 0:d.index)&&(s=we.nextNode(),l++)}return we.currentNode=Ce,r}_update(e){let o=0;for(const i of this._$parts)i!==void 0&&(x==null||x({kind:"set part",part:i,value:e[o],valueIndex:o,values:e,templateInstance:this}),i.strings!==void 0?(i._$setValue(e,i,o),o+=i.strings.length-2):i._$setValue(e[o])),o++}}class st{constructor(e,o,i,n){var r;this.type=Rt,this._$committedValue=$,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=o,this._$parent=i,this.options=n,this.__isConnected=(r=n==null?void 0:n.isConnected)!==null&&r!==void 0?r:!0,this._textSanitizer=void 0}get _$isConnected(){var e,o;return(o=(e=this._$parent)===null||e===void 0?void 0:e._$isConnected)!==null&&o!==void 0?o:this.__isConnected}get parentNode(){let e=q(this._$startNode).parentNode;const o=this._$parent;return o!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=o.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,o=this){var i;if(this.parentNode===null)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=Ue(this,e,o),Ze(e))e===$||e==null||e===""?(this._$committedValue!==$&&(x==null||x({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=$):e!==this._$committedValue&&e!==ke&&this._commitText(e);else if(e._$litType$!==void 0)this._commitTemplateResult(e);else if(e.nodeType!==void 0){if(((i=this.options)===null||i===void 0?void 0:i.host)===e){this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");return}this._commitNode(e)}else Mr(e)?this._commitIterable(e):this._commitText(e)}_insert(e){return q(q(this._$startNode).parentNode).insertBefore(e,this._$endNode)}_commitNode(e){var o;if(this._$committedValue!==e){if(this._$clear(),Te!==Ut){const i=(o=this._$startNode.parentNode)===null||o===void 0?void 0:o.nodeName;if(i==="STYLE"||i==="SCRIPT"){let n="Forbidden";throw i==="STYLE"?n="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and make do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":n="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(n)}}x==null||x({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==$&&Ze(this._$committedValue)){const o=q(this._$startNode).nextSibling;this._textSanitizer===void 0&&(this._textSanitizer=ko(o,"data","property")),e=this._textSanitizer(e),x==null||x({kind:"commit text",node:o,value:e,options:this.options}),o.data=e}else{const o=Ce.createTextNode("");this._commitNode(o),this._textSanitizer===void 0&&(this._textSanitizer=ko(o,"data","property")),e=this._textSanitizer(e),x==null||x({kind:"commit text",node:o,value:e,options:this.options}),o.data=e}this._$committedValue=e}_commitTemplateResult(e){var o;const{values:i,["_$litType$"]:n}=e,r=typeof n=="number"?this._$getTemplate(e):(n.el===void 0&&(n.el=et.createElement(En(n.h,n.h[0]),this.options)),n);if(((o=this._$committedValue)===null||o===void 0?void 0:o._$template)===r)x==null||x({kind:"template updating",template:r,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:i}),this._$committedValue._update(i);else{const s=new Yr(r,this),l=s._clone(this.options);x==null||x({kind:"template instantiated",template:r,instance:s,parts:s._$parts,options:this.options,fragment:l,values:i}),s._update(i),x==null||x({kind:"template instantiated and updated",template:r,instance:s,parts:s._$parts,options:this.options,fragment:l,values:i}),this._commitNode(l),this._$committedValue=s}}_$getTemplate(e){let o=Ri.get(e.strings);return o===void 0&&Ri.set(e.strings,o=new et(e)),o}_commitIterable(e){xn(this._$committedValue)||(this._$committedValue=[],this._$clear());const o=this._$committedValue;let i=0,n;for(const r of e)i===o.length?o.push(n=new st(this._insert(Qe()),this._insert(Qe()),this,this.options)):n=o[i],n._$setValue(r),i++;i<o.length&&(this._$clear(n&&q(n._$endNode).nextSibling,i),o.length=i)}_$clear(e=q(this._$startNode).nextSibling,o){var i;for((i=this._$notifyConnectionChanged)===null||i===void 0||i.call(this,!1,!0,o);e&&e!==this._$endNode;){const n=q(e).nextSibling;q(e).remove(),e=n}}setConnected(e){var o;if(this._$parent===void 0)this.__isConnected=e,(o=this._$notifyConnectionChanged)===null||o===void 0||o.call(this,e);else throw new Error("part.setConnected() may only be called on a RootPart returned from render().")}}class jt{constructor(e,o,i,n,r){this.type=Do,this._$committedValue=$,this._$disconnectableChildren=void 0,this.element=e,this.name=o,this._$parent=n,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$committedValue=new Array(i.length-1).fill(new String),this.strings=i):this._$committedValue=$,this._sanitizer=void 0}get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e,o=this,i,n){const r=this.strings;let s=!1;if(r===void 0)e=Ue(this,e,o,0),s=!Ze(e)||e!==this._$committedValue&&e!==ke,s&&(this._$committedValue=e);else{const l=e;e=r[0];let a,d;for(a=0;a<r.length-1;a++)d=Ue(this,l[i+a],o,a),d===ke&&(d=this._$committedValue[a]),s||(s=!Ze(d)||d!==this._$committedValue[a]),d===$?e=$:e!==$&&(e+=(d??"")+r[a+1]),this._$committedValue[a]=d}s&&!n&&this._commitValue(e)}_commitValue(e){e===$?q(this.element).removeAttribute(this.name):(this._sanitizer===void 0&&(this._sanitizer=Te(this.element,this.name,"attribute")),e=this._sanitizer(e??""),x==null||x({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),q(this.element).setAttribute(this.name,e??""))}}class Jr extends jt{constructor(){super(...arguments),this.type=Hr}_commitValue(e){this._sanitizer===void 0&&(this._sanitizer=Te(this.element,this.name,"property")),e=this._sanitizer(e),x==null||x({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===$?void 0:e}}const Xr=De?De.emptyScript:"";class Qr extends jt{constructor(){super(...arguments),this.type=qr}_commitValue(e){x==null||x({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(e&&e!==$),options:this.options}),e&&e!==$?q(this.element).setAttribute(this.name,Xr):q(this.element).removeAttribute(this.name)}}class Zr extends jt{constructor(e,o,i,n,r){if(super(e,o,i,n,r),this.type=Wr,this.strings!==void 0)throw new Error(`A \`<${e.localName}>\` has a \`@${o}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,o=this){var i;if(e=(i=Ue(this,e,o,0))!==null&&i!==void 0?i:$,e===ke)return;const n=this._$committedValue,r=e===$&&n!==$||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,s=e!==$&&(n===$||r);x==null||x({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:r,addListener:s,oldListener:n}),r&&this.element.removeEventListener(this.name,this,n),s&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){var o,i;typeof this._$committedValue=="function"?this._$committedValue.call((i=(o=this.options)===null||o===void 0?void 0:o.host)!==null&&i!==void 0?i:this.element,e):this._$committedValue.handleEvent(e)}}class es{constructor(e,o,i){this.element=e,this.type=Uo,this._$disconnectableChildren=void 0,this._$parent=o,this.options=i}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){x==null||x({kind:"commit to element binding",element:this.element,value:e,options:this.options}),Ue(this,e)}}const lo=F.litHtmlPolyfillSupportDevMode;lo==null||lo(et,st);((io=F.litHtmlVersions)!==null&&io!==void 0?io:F.litHtmlVersions=[]).push("2.8.0");F.litHtmlVersions.length>1&&$t("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");const Ee=(t,e,o)=>{var i,n;if(e==null)throw new TypeError(`The container to render into may not be ${e}`);const r=Ir++,s=(i=o==null?void 0:o.renderBefore)!==null&&i!==void 0?i:e;let l=s._$litPart$;if(x==null||x({kind:"begin render",id:r,value:t,container:e,options:o,part:l}),l===void 0){const a=(n=o==null?void 0:o.renderBefore)!==null&&n!==void 0?n:null;s._$litPart$=l=new st(e.insertBefore(Qe(),a),a,void 0,o??{})}return l._$setValue(t),x==null||x({kind:"end render",id:r,value:t,container:e,options:o,part:l}),l};Ee.setSanitizer=Or,Ee.createSanitizer=ko,Ee._testOnlyClearSanitizerFactoryDoNotCallOrElse=Lr;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var co,ho,uo;let jo;{const t=(co=globalThis.litIssuedWarnings)!==null&&co!==void 0?co:globalThis.litIssuedWarnings=new Set;jo=(e,o)=>{o+=` See https://lit.dev/msg/${e} for more information.`,t.has(o)||(console.warn(o),t.add(o))}}class A extends ie{constructor(){super(...arguments),this.renderOptions={host:this},this.__childPart=void 0}createRenderRoot(){var e,o;const i=super.createRenderRoot();return(e=(o=this.renderOptions).renderBefore)!==null&&e!==void 0||(o.renderBefore=i.firstChild),i}update(e){const o=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this.__childPart=Ee(o,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this.__childPart)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.__childPart)===null||e===void 0||e.setConnected(!1)}render(){return ke}}A.finalized=!0;A._$litElement$=!0;(ho=globalThis.litElementHydrateSupport)===null||ho===void 0||ho.call(globalThis,{LitElement:A});const po=globalThis.litElementPolyfillSupportDevMode;po==null||po({LitElement:A});A.finalize=function(){if(!ie.finalize.call(this))return!1;const e=(o,i,n=!1)=>{if(o.hasOwnProperty(i)){const r=(typeof o=="function"?o:o.constructor).name;jo(n?"renamed-api":"removed-api",`\`${i}\` is implemented on class ${r}. It has been ${n?"renamed":"removed"} in this version of LitElement.`)}};return e(this,"render"),e(this,"getStyles",!0),e(this.prototype,"adoptStyles"),!0};((uo=globalThis.litElementVersions)!==null&&uo!==void 0?uo:globalThis.litElementVersions=[]).push("3.3.3");globalThis.litElementVersions.length>1&&jo("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */class cs extends ds{constructor(e){var o;if(super(e),e.type!==as.ATTRIBUTE||e.name!=="class"||((o=e.strings)===null||o===void 0?void 0:o.length)>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(o=>e[o]).join(" ")+" "}update(e,[o]){var i,n;if(this._previousClasses===void 0){this._previousClasses=new Set,e.strings!==void 0&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in o)o[s]&&!(!((i=this._staticClasses)===null||i===void 0)&&i.has(s))&&this._previousClasses.add(s);return this.render(o)}const r=e.element.classList;this._previousClasses.forEach(s=>{s in o||(r.remove(s),this._previousClasses.delete(s))});for(const s in o){const l=!!o[s];l!==this._previousClasses.has(s)&&!(!((n=this._staticClasses)===null||n===void 0)&&n.has(s))&&(l?(r.add(s),this._previousClasses.add(s)):(r.remove(s),this._previousClasses.delete(s)))}return ke}}const Fo=ls(cs),vo="css-loading-indicator";var K;(function(t){t.IDLE="",t.FIRST="first",t.SECOND="second",t.THIRD="third"})(K||(K={}));class O extends A{constructor(){super(),this.firstDelay=450,this.secondDelay=1500,this.thirdDelay=5e3,this.expandedDuration=2e3,this.onlineText="Online",this.offlineText="Connection lost",this.reconnectingText="Connection lost, trying to reconnect...",this.offline=!1,this.reconnecting=!1,this.expanded=!1,this.loading=!1,this.loadingBarState=K.IDLE,this.applyDefaultThemeState=!0,this.firstTimeout=0,this.secondTimeout=0,this.thirdTimeout=0,this.expandedTimeout=0,this.lastMessageState=R.CONNECTED,this.connectionStateListener=()=>{this.expanded=this.updateConnectionState(),this.expandedTimeout=this.timeoutFor(this.expandedTimeout,this.expanded,()=>{this.expanded=!1},this.expandedDuration)}}static create(){var e,o;const i=window;return!((e=i.Vaadin)===null||e===void 0)&&e.connectionIndicator||(i.Vaadin=i.Vaadin||{},i.Vaadin.connectionIndicator=document.createElement("vaadin-connection-indicator"),document.body.appendChild(i.Vaadin.connectionIndicator)),(o=i.Vaadin)===null||o===void 0?void 0:o.connectionIndicator}render(){return b`
    ...
    `}getLoadingBarStyle(){switch(this.loadingBarState){case K.IDLE:return"display: none";case K.FIRST:case K.SECOND:case K.THIRD:return"display: block";default:return""}}timeoutFor(e,o,i,n){return e!==0&&window.clearTimeout(e),o?window.setTimeout(i,n):0}static get instance(){return O.create()}}B([_({type:Number})],O.prototype,"firstDelay",void 0);B([_({type:Number})],O.prototype,"secondDelay",void 0);B([_({type:Number})],O.prototype,"thirdDelay",void 0);B([_({type:Number})],O.prototype,"expandedDuration",void 0);B([_({type:String})],O.prototype,"onlineText",void 0);B([_({type:String})],O.prototype,"offlineText",void 0);B([_({type:String})],O.prototype,"reconnectingText",void 0);B([_({type:Boolean,reflect:!0})],O.prototype,"offline",void 0);B([_({type:Boolean,reflect:!0})],O.prototype,"reconnecting",void 0);B([_({type:Boolean,reflect:!0})],O.prototype,"expanded",void 0);B([_({type:Boolean,reflect:!0})],O.prototype,"loading",void 0);B([_({type:String})],O.prototype,"loadingBarState",void 0);B([_({type:Boolean})],O.prototype,"applyDefaultTheme",null);customElements.get("vaadin-connection-indicator")===void 0&&customElements.define("vaadin-connection-indicator",O);O.instance;const tt=window;tt.Vaadin=tt.Vaadin||{};tt.Vaadin.registrations=tt.Vaadin.registrations||[];tt.Vaadin.registrations.push({is:"@vaadin/common-frontend",version:"0.0.18"});class Ni extends Error{}const Ge=window.document.body,k=window;class hs{constructor(e){this.response=void 0,this.pathname="",this.isActive=!1,this.baseRegex=/^\//,this.navigation="",Ge.$=Ge.$||[],this.config=e||{},k.Vaadin=k.Vaadin||{},k.Vaadin.Flow=k.Vaadin.Flow||{},k.Vaadin.Flow.clients={TypeScript:{isActive:()=>this.isActive}};const o=document.head.querySelector("base");this.baseRegex=new RegExp(`^${(document.baseURI||o&&o.href||"/").replace(/^https?:\/\/[^/]+/i,"")}`),this.appShellTitle=document.title,this.addConnectionIndicator()}get serverSideRoutes(){return[{path:"(.*)",action:this.action}]}loadingStarted(){this.isActive=!0,k.Vaadin.connectionState.loadingStarted()}loadingFinished(){this.isActive=!1,k.Vaadin.connectionState.loadingFinished(),!k.Vaadin.listener&&(k.Vaadin.listener={},document.addEventListener("click",e=>{e.target&&(e.target.hasAttribute("router-link")?this.navigation="link":e.composedPath().some(o=>o.nodeName==="A")&&(this.navigation="client"))},{capture:!0}))}get action(){return async e=>{if(this.pathname=e.pathname,k.Vaadin.connectionState.online)try{await this.flowInit()}catch(o){if(o instanceof Ni)return k.Vaadin.connectionState.state=R.CONNECTION_LOST,this.offlineStubAction();throw o}else return this.offlineStubAction();return this.container.onBeforeEnter=(o,i)=>this.flowNavigate(o,i),this.container.onBeforeLeave=(o,i)=>this.flowLeave(o,i),this.container}}async flowLeave(e,o){const{connectionState:i}=k.Vaadin;return this.pathname===e.pathname||!this.isFlowClientLoaded()||i.offline?Promise.resolve({}):new Promise(n=>{this.loadingStarted(),this.container.serverConnected=r=>{n(o&&r?o.prevent():{}),this.loadingFinished()},Ge.$server.leaveNavigation(this.getFlowRoutePath(e),this.getFlowRouteQuery(e))})}async flowNavigate(e,o){return this.response?new Promise(i=>{this.loadingStarted(),this.container.serverConnected=(n,r)=>{o&&n?i(o.prevent()):o&&o.redirect&&r?i(o.redirect(r.pathname)):(this.container.style.display="",i(this.container)),this.loadingFinished()},this.container.serverPaused=()=>{this.loadingFinished()},Ge.$server.connectClient(this.getFlowRoutePath(e),this.getFlowRouteQuery(e),this.appShellTitle,history.state,this.navigation),this.navigation="history"}):Promise.resolve(this.container)}getFlowRoutePath(e){return decodeURIComponent(e.pathname).replace(this.baseRegex,"")}getFlowRouteQuery(e){return e.search&&e.search.substring(1)||""}async flowInit(){if(!this.isFlowClientLoaded()){this.loadingStarted(),this.response=await this.flowInitUi();const{pushScript:e,appConfig:o}=this.response;typeof e=="string"&&await this.loadScript(e);const{appId:i}=o;await(await f(()=>import("./FlowBootstrap-feff2646.js"),[],import.meta.url)).init(this.response),typeof this.config.imports=="function"&&(this.injectAppIdScript(i),await this.config.imports());const r=`flow-container-${i.toLowerCase()}`,s=document.querySelector(r);s?this.container=s:(this.container=document.createElement(r),this.container.id=i),Ge.$[i]=this.container;const l=await f(()=>import("./FlowClient-341d667e.js"),[],import.meta.url);await this.flowInitClient(l),this.loadingFinished()}return this.container&&!this.container.isConnected&&(this.container.style.display="none",document.body.appendChild(this.container)),this.response}async loadScript(e){return new Promise((o,i)=>{const n=document.createElement("script");n.onload=()=>o(),n.onerror=i,n.src=e,document.body.appendChild(n)})}injectAppIdScript(e){const o=e.substring(0,e.lastIndexOf("-")),i=document.createElement("script");i.type="module",i.setAttribute("data-app-id",o),document.body.append(i)}async flowInitClient(e){return e.init(),new Promise(o=>{const i=setInterval(()=>{Object.keys(k.Vaadin.Flow.clients).filter(r=>r!=="TypeScript").reduce((r,s)=>r||k.Vaadin.Flow.clients[s].isActive(),!1)||(clearInterval(i),o())},5)})}async flowInitUi(){const e=k.Vaadin&&k.Vaadin.TypeScript&&k.Vaadin.TypeScript.initial;return e?(k.Vaadin.TypeScript.initial=void 0,Promise.resolve(e)):new Promise((o,i)=>{const r=new XMLHttpRequest,s=`?v-r=init&location=${encodeURIComponent(this.getFlowRoutePath(location))}&query=${encodeURIComponent(this.getFlowRouteQuery(location))}`;r.open("GET",s),r.onerror=()=>i(new Ni(`Invalid server response when initializing Flow UI.
        ${r.status}
        ${r.responseText}`)),r.onload=()=>{const l=r.getResponseHeader("content-type");l&&l.indexOf("application/json")!==-1?o(JSON.parse(r.responseText)):r.onerror()},r.send()})}addConnectionIndicator(){O.create(),k.addEventListener("online",()=>{if(!this.isFlowClientLoaded()){k.Vaadin.connectionState.state=R.RECONNECTING;const e=new XMLHttpRequest;e.open("HEAD","sw.js"),e.onload=()=>{k.Vaadin.connectionState.state=R.CONNECTED},e.onerror=()=>{k.Vaadin.connectionState.state=R.CONNECTION_LOST},setTimeout(()=>e.send(),50)}}),k.addEventListener("offline",()=>{this.isFlowClientLoaded()||(k.Vaadin.connectionState.state=R.CONNECTION_LOST)})}async offlineStubAction(){const e=document.createElement("iframe"),o="./offline-stub.html";e.setAttribute("src",o),e.setAttribute("style","width: 100%; height: 100%; border: 0"),this.response=void 0;let i;const n=()=>{i!==void 0&&(k.Vaadin.connectionState.removeStateChangeListener(i),i=void 0)};return e.onBeforeEnter=(r,s,l)=>{i=()=>{k.Vaadin.connectionState.online&&(n(),l.render(r,!1))},k.Vaadin.connectionState.addStateChangeListener(i)},e.onBeforeLeave=(r,s,l)=>{n()},e}isFlowClientLoaded(){return this.response!==void 0}}const{serverSideRoutes:us}=new hs({imports:()=>f(()=>import("./generated-flow-imports-87d13f92.js"),[],import.meta.url)}),ps=[...us],ms=new pe(document.querySelector("#outlet"));ms.setRoutes(ps);(function(){if(typeof document>"u"||"adoptedStyleSheets"in document)return;var t="ShadyCSS"in window&&!ShadyCSS.nativeShadow,e=document.implementation.createHTMLDocument(""),o=new WeakMap,i=typeof DOMException=="object"?Error:DOMException,n=Object.defineProperty,r=Array.prototype.forEach,s=/@import.+?;?$/gm;function l(u){var p=u.replace(s,"");return p!==u&&console.warn("@import rules are not allowed here. See https://github.com/WICG/construct-stylesheets/issues/119#issuecomment-588352418"),p.trim()}function a(u){return"isConnected"in u?u.isConnected:document.contains(u)}function d(u){return u.filter(function(p,E){return u.indexOf(p)===E})}function c(u,p){return u.filter(function(E){return p.indexOf(E)===-1})}function m(u){u.parentNode.removeChild(u)}function h(u){return u.shadowRoot||o.get(u)}var y=["addRule","deleteRule","insertRule","removeRule"],ce=CSSStyleSheet,he=ce.prototype;he.replace=function(){return Promise.reject(new i("Can't call replace on non-constructed CSSStyleSheets."))},he.replaceSync=function(){throw new i("Failed to execute 'replaceSync' on 'CSSStyleSheet': Can't call replaceSync on non-constructed CSSStyleSheets.")};function ne(u){return typeof u=="object"?Re.isPrototypeOf(u)||he.isPrototypeOf(u):!1}function Ft(u){return typeof u=="object"?he.isPrototypeOf(u):!1}var H=new WeakMap,ee=new WeakMap,$e=new WeakMap,Ae=new WeakMap;function Bt(u,p){var E=document.createElement("style");return $e.get(u).set(p,E),ee.get(u).push(p),E}function re(u,p){return $e.get(u).get(p)}function lt(u,p){$e.get(u).delete(p),ee.set(u,ee.get(u).filter(function(E){return E!==p}))}function Qo(u,p){requestAnimationFrame(function(){p.textContent=H.get(u).textContent,Ae.get(u).forEach(function(E){return p.sheet[E.method].apply(p.sheet,E.args)})})}function dt(u){if(!H.has(u))throw new TypeError("Illegal invocation")}function Ht(){var u=this,p=document.createElement("style");e.body.appendChild(p),H.set(u,p),ee.set(u,[]),$e.set(u,new WeakMap),Ae.set(u,[])}var Re=Ht.prototype;Re.replace=function(p){try{return this.replaceSync(p),Promise.resolve(this)}catch(E){return Promise.reject(E)}},Re.replaceSync=function(p){if(dt(this),typeof p=="string"){var E=this;H.get(E).textContent=l(p),Ae.set(E,[]),ee.get(E).forEach(function(V){V.isConnected()&&Qo(E,re(E,V))})}},n(Re,"cssRules",{configurable:!0,enumerable:!0,get:function(){return dt(this),H.get(this).sheet.cssRules}}),n(Re,"media",{configurable:!0,enumerable:!0,get:function(){return dt(this),H.get(this).sheet.media}}),y.forEach(function(u){Re[u]=function(){var p=this;dt(p);var E=arguments;Ae.get(p).push({method:u,args:E}),ee.get(p).forEach(function(U){if(U.isConnected()){var L=re(p,U).sheet;L[u].apply(L,E)}});var V=H.get(p).sheet;return V[u].apply(V,E)}}),n(Ht,Symbol.hasInstance,{configurable:!0,value:ne});var Zo={childList:!0,subtree:!0},ei=new WeakMap;function Ne(u){var p=ei.get(u);return p||(p=new ii(u),ei.set(u,p)),p}function ti(u){n(u.prototype,"adoptedStyleSheets",{configurable:!0,enumerable:!0,get:function(){return Ne(this).sheets},set:function(p){Ne(this).update(p)}})}function qt(u,p){for(var E=document.createNodeIterator(u,NodeFilter.SHOW_ELEMENT,function(U){return h(U)?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT},null,!1),V=void 0;V=E.nextNode();)p(h(V))}var ct=new WeakMap,Ie=new WeakMap,ht=new WeakMap;function Mn(u,p){return p instanceof HTMLStyleElement&&Ie.get(u).some(function(E){return re(E,u)})}function oi(u){var p=ct.get(u);return p instanceof Document?p.body:p}function Wt(u){var p=document.createDocumentFragment(),E=Ie.get(u),V=ht.get(u),U=oi(u);V.disconnect(),E.forEach(function(L){p.appendChild(re(L,u)||Bt(L,u))}),U.insertBefore(p,null),V.observe(U,Zo),E.forEach(function(L){Qo(L,re(L,u))})}function ii(u){var p=this;p.sheets=[],ct.set(p,u),Ie.set(p,[]),ht.set(p,new MutationObserver(function(E,V){if(!document){V.disconnect();return}E.forEach(function(U){t||r.call(U.addedNodes,function(L){L instanceof Element&&qt(L,function(Pe){Ne(Pe).connect()})}),r.call(U.removedNodes,function(L){L instanceof Element&&(Mn(p,L)&&Wt(p),t||qt(L,function(Pe){Ne(Pe).disconnect()}))})})}))}if(ii.prototype={isConnected:function(){var u=ct.get(this);return u instanceof Document?u.readyState!=="loading":a(u.host)},connect:function(){var u=oi(this);ht.get(this).observe(u,Zo),Ie.get(this).length>0&&Wt(this),qt(u,function(p){Ne(p).connect()})},disconnect:function(){ht.get(this).disconnect()},update:function(u){var p=this,E=ct.get(p)===document?"Document":"ShadowRoot";if(!Array.isArray(u))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+E+": Iterator getter is not callable.");if(!u.every(ne))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+E+": Failed to convert value to 'CSSStyleSheet'");if(u.some(Ft))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+E+": Can't adopt non-constructed stylesheets");p.sheets=u;var V=Ie.get(p),U=d(u),L=c(V,U);L.forEach(function(Pe){m(re(Pe,p)),lt(Pe,p)}),Ie.set(p,U),p.isConnected()&&U.length>0&&Wt(p)}},window.CSSStyleSheet=Ht,ti(Document),"ShadowRoot"in window){ti(ShadowRoot);var ni=Element.prototype,Vn=ni.attachShadow;ni.attachShadow=function(p){var E=Vn.call(this,p);return p.mode==="closed"&&o.set(this,E),E}}var ut=Ne(document);ut.isConnected()?ut.connect():document.addEventListener("DOMContentLoaded",ut.connect.bind(ut))})();/**
 * @license
 ...
 */const Sn=Symbol.for(""),vs=t=>{if((t==null?void 0:t.r)===Sn)return t==null?void 0:t._$litStatic$},gs=t=>{if(t._$litStatic$!==void 0)return t._$litStatic$;throw new Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)},vt=(t,...e)=>({_$litStatic$:e.reduce((o,i,n)=>o+gs(i)+t[n+1],t[0]),r:Sn}),Ii=new Map,fs=t=>(e,...o)=>{const i=o.length;let n,r;const s=[],l=[];let a=0,d=!1,c;for(;a<i;){for(c=e[a];a<i&&(r=o[a],(n=vs(r))!==void 0);)c+=n+e[++a],d=!0;a!==i&&l.push(r),s.push(c),a++}if(a===i&&s.push(e[i]),d){const m=s.join("$$lit$$");e=Ii.get(m),e===void 0&&(s.raw=s,Ii.set(m,e=s)),o=l}return t(e,...o)},ys=fs(b),bs="modulepreload",xs=function(t){return"/"+t},Pi={},g=function(t,e,o){if(!e||e.length===0)return t();const i=document.getElementsByTagName("link");return Promise.all(e.map(n=>{if(n=xs(n),n in Pi)return;Pi[n]=!0;const r=n.endsWith(".css"),s=r?'[rel="stylesheet"]':"";if(o)for(let a=i.length-1;a>=0;a--){const d=i[a];if(d.href===n&&(!r||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${s}`))return;const l=document.createElement("link");if(l.rel=r?"stylesheet":bs,r||(l.as="script",l.crossOrigin=""),l.href=n,document.head.appendChild(l),r)return new Promise((a,d)=>{l.addEventListener("load",a),l.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${n}`)))})})).then(()=>t()).catch(n=>{const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=n,window.dispatchEvent(r),!r.defaultPrevented)throw n})};function v(t,e,o,i){var n=arguments.length,r=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,o):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(t,e,o,i);else for(var l=t.length-1;l>=0;l--)(s=t[l])&&(r=(n<3?s(r):n>3?s(e,o,r):s(e,o))||r);return n>3&&r&&Object.defineProperty(e,o,r),r}function _s(t){var e;const o=[];for(;t&&t.parentNode;){const i=$o(t);if(i.nodeId!==-1){if((e=i.element)!=null&&e.tagName.startsWith("FLOW-CONTAINER-"))break;o.push(i)}t=t.parentElement?t.parentElement:t.parentNode.host}return o.reverse()}function $o(t){const e=window.Vaadin;if(e&&e.Flow){const{clients:o}=e.Flow,i=Object.keys(o);for(const n of i){const r=o[n];if(r.getNodeId){const s=r.getNodeId(t);if(s>=0)return{nodeId:s,uiId:r.getUIId(),element:t}}}}return{nodeId:-1,uiId:-1,element:void 0}}function ws(t,e){if(t.contains(e))return!0;let o=e;const i=e.ownerDocument;for(;o&&o!==i&&o!==t;)o=o.parentNode||(o instanceof ShadowRoot?o.host:null);return o===t}const Es=(t,e)=>{const o=t[e];return o?typeof o=="function"?o():Promise.resolve(o):new Promise((i,n)=>{(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(n.bind(null,new Error("Unknown variable dynamic import: "+e)))})};var N;(function(t){t.text="text",t.checkbox="checkbox",t.range="range",t.color="color"})(N||(N={}));const Z={lumoSize:["--lumo-size-xs","--lumo-size-s","--lumo-size-m","--lumo-size-l","--lumo-size-xl"],lumoSpace:["--lumo-space-xs","--lumo-space-s","--lumo-space-m","--lumo-space-l","--lumo-space-xl"],lumoBorderRadius:["0","--lumo-border-radius-m","--lumo-border-radius-l"],lumoFontSize:["--lumo-font-size-xxs","--lumo-font-size-xs","--lumo-font-size-s","--lumo-font-size-m","--lumo-font-size-l","--lumo-font-size-xl","--lumo-font-size-xxl","--lumo-font-size-xxxl"],lumoTextColor:["--lumo-header-text-color","--lumo-body-text-color","--lumo-secondary-text-color","--lumo-tertiary-text-color","--lumo-disabled-text-color","--lumo-primary-text-color","--lumo-error-text-color","--lumo-success-text-color"],basicBorderSize:["0px","1px","2px","3px"]},Ss=Object.freeze(Object.defineProperty({__proto__:null,presets:Z},Symbol.toStringTag,{value:"Module"})),ae={textColor:{propertyName:"color",displayName:"Text color",editorType:N.color,presets:Z.lumoTextColor},fontSize:{propertyName:"font-size",displayName:"Font size",editorType:N.range,presets:Z.lumoFontSize,icon:"font"},fontWeight:{propertyName:"font-weight",displayName:"Bold",editorType:N.checkbox,checkedValue:"bold"},fontStyle:{propertyName:"font-style",displayName:"Italic",editorType:N.checkbox,checkedValue:"italic"}},X={backgroundColor:{propertyName:"background-color",displayName:"Background color",editorType:N.color},borderColor:{propertyName:"border-color",displayName:"Border color",editorType:N.color},borderWidth:{propertyName:"border-width",displayName:"Border width",editorType:N.range,presets:Z.basicBorderSize,icon:"square"},borderRadius:{propertyName:"border-radius",displayName:"Border radius",editorType:N.range,presets:Z.lumoBorderRadius,icon:"square"},padding:{propertyName:"padding",displayName:"Padding",editorType:N.range,presets:Z.lumoSpace,icon:"square"},gap:{propertyName:"gap",displayName:"Spacing",editorType:N.range,presets:Z.lumoSpace,icon:"square"}},Cs={height:{propertyName:"height",displayName:"Size",editorType:N.range,presets:Z.lumoSize,icon:"square"},paddingInline:{propertyName:"padding-inline",displayName:"Padding",editorType:N.range,presets:Z.lumoSpace,icon:"square"}},Ao={iconColor:{propertyName:"color",displayName:"Icon color",editorType:N.color,presets:Z.lumoTextColor},iconSize:{propertyName:"font-size",displayName:"Icon size",editorType:N.range,presets:Z.lumoFontSize,icon:"font"}},ks=[X.backgroundColor,X.borderColor,X.borderWidth,X.borderRadius,X.padding],Ts=[ae.textColor,ae.fontSize,ae.fontWeight,ae.fontStyle],$s=[Ao.iconColor,Ao.iconSize],As=Object.freeze(Object.defineProperty({__proto__:null,fieldProperties:Cs,iconProperties:Ao,shapeProperties:X,standardIconProperties:$s,standardShapeProperties:ks,standardTextProperties:Ts,textProperties:ae},Symbol.toStringTag,{value:"Module"}));function Cn(t){const e=t.charAt(0).toUpperCase()+t.slice(1);return{tagName:t,displayName:e,elements:[{selector:t,displayName:"Element",properties:[X.backgroundColor,X.borderColor,X.borderWidth,X.borderRadius,X.padding,ae.textColor,ae.fontSize,ae.fontWeight,ae.fontStyle]}]}}const Rs=Object.freeze(Object.defineProperty({__proto__:null,createGenericMetadata:Cn},Symbol.toStringTag,{value:"Module"})),Ns=t=>Es(Object.assign({"./components/defaults.ts":()=>g(()=>Promise.resolve().then(()=>As),void 0),"./components/generic.ts":()=>g(()=>Promise.resolve().then(()=>Rs),void 0),"./components/presets.ts":()=>g(()=>Promise.resolve().then(()=>Ss),void 0),"./components/vaadin-accordion-heading.ts":()=>g(()=>f(()=>import("./vaadin-accordion-heading-c0acdd6d-a04fa5fe.js"),[],import.meta.url),[]),"./components/vaadin-accordion-panel.ts":()=>g(()=>f(()=>import("./vaadin-accordion-panel-616e55d6-1b82a1c0.js"),[],import.meta.url),[]),"./components/vaadin-accordion.ts":()=>g(()=>f(()=>import("./vaadin-accordion-eed3b794-fb2dd57e.js"),[],import.meta.url),[]),"./components/vaadin-app-layout.ts":()=>g(()=>f(()=>import("./vaadin-app-layout-e56de2e9-d8331ebc.js"),[],import.meta.url),[]),"./components/vaadin-avatar.ts":()=>g(()=>f(()=>import("./vaadin-avatar-7599297d-72afe56e.js"),[],import.meta.url),[]),"./components/vaadin-big-decimal-field.ts":()=>g(()=>f(()=>import("./vaadin-big-decimal-field-e51def24-f7af7b07.js"),["./vaadin-big-decimal-field-e51def24-f7af7b07.js","./vaadin-text-field-0b3db014-63c14793.js","./vaadin-button-2511ad84-aa6f4c44.js"],import.meta.url),["assets/vaadin-big-decimal-field-e51def24.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-board-row.ts":()=>g(()=>f(()=>import("./vaadin-board-row-c70d0c55-881ad00a.js"),[],import.meta.url),[]),"./components/vaadin-board.ts":()=>g(()=>f(()=>import("./vaadin-board-828ebdea-c0c949e1.js"),[],import.meta.url),[]),"./components/vaadin-button.ts":()=>g(()=>f(()=>import("./vaadin-button-2511ad84-aa6f4c44.js"),[],import.meta.url),[]),"./components/vaadin-chart.ts":()=>g(()=>f(()=>import("./vaadin-chart-5192dc15-8f570373.js"),[],import.meta.url),[]),"./components/vaadin-checkbox-group.ts":()=>g(()=>f(()=>import("./vaadin-checkbox-group-a7c65bf2-85646a09.js"),["./vaadin-checkbox-group-a7c65bf2-85646a09.js","./vaadin-text-field-0b3db014-63c14793.js","./vaadin-checkbox-4e68df64-08bd2733.js"],import.meta.url),["assets/vaadin-checkbox-group-a7c65bf2.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-checkbox-4e68df64.js"]),"./components/vaadin-checkbox.ts":()=>g(()=>f(()=>import("./vaadin-checkbox-4e68df64-08bd2733.js"),[],import.meta.url),[]),"./components/vaadin-combo-box.ts":()=>g(()=>f(()=>import("./vaadin-combo-box-96451ddd-ea51343b.js"),["./vaadin-combo-box-96451ddd-ea51343b.js","./vaadin-text-field-0b3db014-63c14793.js"],import.meta.url),["assets/vaadin-combo-box-96451ddd.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-confirm-dialog.ts":()=>g(()=>f(()=>import("./vaadin-confirm-dialog-4d718829-ed77832d.js"),["./vaadin-confirm-dialog-4d718829-ed77832d.js","./vaadin-button-2511ad84-aa6f4c44.js"],import.meta.url),["assets/vaadin-confirm-dialog-4d718829.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-cookie-consent.ts":()=>g(()=>f(()=>import("./vaadin-cookie-consent-46c09f8b-66e1fd68.js"),[],import.meta.url),[]),"./components/vaadin-crud.ts":()=>g(()=>f(()=>import("./vaadin-crud-8d161a22-7bf58439.js"),[],import.meta.url),[]),"./components/vaadin-custom-field.ts":()=>g(()=>f(()=>import("./vaadin-custom-field-42c85b9e-fcae0a3e.js"),["./vaadin-custom-field-42c85b9e-fcae0a3e.js","./vaadin-text-field-0b3db014-63c14793.js"],import.meta.url),["assets/vaadin-custom-field-42c85b9e.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-date-picker.ts":()=>g(()=>f(()=>import("./vaadin-date-picker-f2001167-1b122161.js"),["./vaadin-date-picker-f2001167-1b122161.js","./vaadin-text-field-0b3db014-63c14793.js"],import.meta.url),["assets/vaadin-date-picker-f2001167.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-date-time-picker.ts":()=>g(()=>f(()=>import("./vaadin-date-time-picker-c8c047a7-ba991c38.js"),["./vaadin-date-time-picker-c8c047a7-ba991c38.js","./vaadin-text-field-0b3db014-63c14793.js"],import.meta.url),["assets/vaadin-date-time-picker-c8c047a7.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-details-summary.ts":()=>g(()=>f(()=>import("./vaadin-details-summary-351a1448-ee12fc86.js"),[],import.meta.url),[]),"./components/vaadin-details.ts":()=>g(()=>f(()=>import("./vaadin-details-bf336660-4e38e3f7.js"),[],import.meta.url),[]),"./components/vaadin-dialog.ts":()=>g(()=>f(()=>import("./vaadin-dialog-53253a08-8621f2fc.js"),[],import.meta.url),[]),"./components/vaadin-email-field.ts":()=>g(()=>f(()=>import("./vaadin-email-field-d7a35f04-40fa4dc7.js"),["./vaadin-email-field-d7a35f04-40fa4dc7.js","./vaadin-text-field-0b3db014-63c14793.js","./vaadin-button-2511ad84-aa6f4c44.js"],import.meta.url),["assets/vaadin-email-field-d7a35f04.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-form-layout.ts":()=>g(()=>f(()=>import("./vaadin-form-layout-47744b1d-4d4fc796.js"),[],import.meta.url),[]),"./components/vaadin-grid-pro.ts":()=>g(()=>f(()=>import("./vaadin-grid-pro-ff415555-a6da66d3.js"),["./vaadin-grid-pro-ff415555-a6da66d3.js","./vaadin-checkbox-4e68df64-08bd2733.js","./vaadin-grid-0a4791c2-f77f3be0.js","./vaadin-text-field-0b3db014-63c14793.js"],import.meta.url),["assets/vaadin-grid-pro-ff415555.js","assets/vaadin-checkbox-4e68df64.js","assets/vaadin-grid-0a4791c2.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-grid.ts":()=>g(()=>f(()=>import("./vaadin-grid-0a4791c2-f77f3be0.js"),["./vaadin-grid-0a4791c2-f77f3be0.js","./vaadin-checkbox-4e68df64-08bd2733.js"],import.meta.url),["assets/vaadin-grid-0a4791c2.js","assets/vaadin-checkbox-4e68df64.js"]),"./components/vaadin-horizontal-layout.ts":()=>g(()=>f(()=>import("./vaadin-horizontal-layout-3193943f-73f1f538.js"),[],import.meta.url),[]),"./components/vaadin-icon.ts":()=>g(()=>f(()=>import("./vaadin-icon-601f36ed-92ca15f9.js"),[],import.meta.url),[]),"./components/vaadin-integer-field.ts":()=>g(()=>f(()=>import("./vaadin-integer-field-85078932-7dd00dec.js"),["./vaadin-integer-field-85078932-7dd00dec.js","./vaadin-text-field-0b3db014-63c14793.js","./vaadin-button-2511ad84-aa6f4c44.js"],import.meta.url),["assets/vaadin-integer-field-85078932.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-list-box.ts":()=>g(()=>f(()=>import("./vaadin-list-box-d7a8433b-f8b18536.js"),[],import.meta.url),[]),"./components/vaadin-login-form.ts":()=>g(()=>f(()=>import("./vaadin-login-form-638996c6-91fc1bdc.js"),["./vaadin-login-form-638996c6-91fc1bdc.js","./vaadin-text-field-0b3db014-63c14793.js","./vaadin-button-2511ad84-aa6f4c44.js"],import.meta.url),["assets/vaadin-login-form-638996c6.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-login-overlay.ts":()=>g(()=>f(()=>import("./vaadin-login-overlay-f8a5db8a-f487b07d.js"),["./vaadin-login-overlay-f8a5db8a-f487b07d.js","./vaadin-text-field-0b3db014-63c14793.js","./vaadin-button-2511ad84-aa6f4c44.js"],import.meta.url),["assets/vaadin-login-overlay-f8a5db8a.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-map.ts":()=>g(()=>f(()=>import("./vaadin-map-d40a0116-21b08d4d.js"),[],import.meta.url),[]),"./components/vaadin-menu-bar.ts":()=>g(()=>f(()=>import("./vaadin-menu-bar-3f5ab096-e4f3a60f.js"),[],import.meta.url),[]),"./components/vaadin-message-input.ts":()=>g(()=>f(()=>import("./vaadin-message-input-996ac37c-d7243ed9.js"),["./vaadin-message-input-996ac37c-d7243ed9.js","./vaadin-text-field-0b3db014-63c14793.js"],import.meta.url),["assets/vaadin-message-input-996ac37c.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-message-list.ts":()=>g(()=>f(()=>import("./vaadin-message-list-70a435ba-1d046519.js"),[],import.meta.url),[]),"./components/vaadin-multi-select-combo-box.ts":()=>g(()=>f(()=>import("./vaadin-multi-select-combo-box-a3373557-64820d80.js"),["./vaadin-multi-select-combo-box-a3373557-64820d80.js","./vaadin-text-field-0b3db014-63c14793.js"],import.meta.url),["assets/vaadin-multi-select-combo-box-a3373557.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-notification.ts":()=>g(()=>f(()=>import("./vaadin-notification-bd6eb776-4c8cef59.js"),[],import.meta.url),[]),"./components/vaadin-number-field.ts":()=>g(()=>f(()=>import("./vaadin-number-field-cb3ee8b2-e16d3814.js"),["./vaadin-number-field-cb3ee8b2-e16d3814.js","./vaadin-text-field-0b3db014-63c14793.js","./vaadin-button-2511ad84-aa6f4c44.js"],import.meta.url),["assets/vaadin-number-field-cb3ee8b2.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-password-field.ts":()=>g(()=>f(()=>import("./vaadin-password-field-d289cb18-1e439610.js"),["./vaadin-password-field-d289cb18-1e439610.js","./vaadin-text-field-0b3db014-63c14793.js","./vaadin-button-2511ad84-aa6f4c44.js"],import.meta.url),["assets/vaadin-password-field-d289cb18.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-progress-bar.ts":()=>g(()=>f(()=>import("./vaadin-progress-bar-309ecf1f-25e3436b.js"),[],import.meta.url),[]),"./components/vaadin-radio-group.ts":()=>g(()=>f(()=>import("./vaadin-radio-group-88b5afd8-a5f36aa7.js"),["./vaadin-radio-group-88b5afd8-a5f36aa7.js","./vaadin-text-field-0b3db014-63c14793.js"],import.meta.url),["assets/vaadin-radio-group-88b5afd8.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-rich-text-editor.ts":()=>g(()=>f(()=>import("./vaadin-rich-text-editor-8cd892f2-b627591e.js"),[],import.meta.url),[]),"./components/vaadin-scroller.ts":()=>g(()=>f(()=>import("./vaadin-scroller-35e68818-316c5e98.js"),[],import.meta.url),[]),"./components/vaadin-select.ts":()=>g(()=>f(()=>import("./vaadin-select-df6e9947-c88f6668.js"),["./vaadin-select-df6e9947-c88f6668.js","./vaadin-text-field-0b3db014-63c14793.js"],import.meta.url),["assets/vaadin-select-df6e9947.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-side-nav-item.ts":()=>g(()=>f(()=>import("./vaadin-side-nav-item-34918f92-a1ff46cf.js"),[],import.meta.url),[]),"./components/vaadin-side-nav.ts":()=>g(()=>f(()=>import("./vaadin-side-nav-ba80d91d-9578fc4b.js"),[],import.meta.url),[]),"./components/vaadin-split-layout.ts":()=>g(()=>f(()=>import("./vaadin-split-layout-80c92131-eb570dd3.js"),[],import.meta.url),[]),"./components/vaadin-spreadsheet.ts":()=>g(()=>f(()=>import("./vaadin-spreadsheet-59d8c5ef-9ce5a6a3.js"),[],import.meta.url),[]),"./components/vaadin-tab.ts":()=>g(()=>f(()=>import("./vaadin-tab-aaf32809-8c9ac80c.js"),[],import.meta.url),[]),"./components/vaadin-tabs.ts":()=>g(()=>f(()=>import("./vaadin-tabs-d9a5e24e-55683078.js"),[],import.meta.url),[]),"./components/vaadin-tabsheet.ts":()=>g(()=>f(()=>import("./vaadin-tabsheet-dd99ed9a-fa3bb9a3.js"),[],import.meta.url),[]),"./components/vaadin-text-area.ts":()=>g(()=>f(()=>import("./vaadin-text-area-83627ebc-46f4632b.js"),["./vaadin-text-area-83627ebc-46f4632b.js","./vaadin-text-field-0b3db014-63c14793.js","./vaadin-button-2511ad84-aa6f4c44.js"],import.meta.url),["assets/vaadin-text-area-83627ebc.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-text-field.ts":()=>g(()=>f(()=>import("./vaadin-text-field-0b3db014-63c14793.js"),[],import.meta.url),[]),"./components/vaadin-time-picker.ts":()=>g(()=>f(()=>import("./vaadin-time-picker-715ec415-08540564.js"),["./vaadin-time-picker-715ec415-08540564.js","./vaadin-text-field-0b3db014-63c14793.js"],import.meta.url),["assets/vaadin-time-picker-715ec415.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-upload.ts":()=>g(()=>f(()=>import("./vaadin-upload-d3c162ed-ba336b60.js"),["./vaadin-upload-d3c162ed-ba336b60.js","./vaadin-button-2511ad84-aa6f4c44.js"],import.meta.url),["assets/vaadin-upload-d3c162ed.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-vertical-layout.ts":()=>g(()=>f(()=>import("./vaadin-vertical-layout-ad4174c4-8ee7af70.js"),[],import.meta.url),[]),"./components/vaadin-virtual-list.ts":()=>g(()=>f(()=>import("./vaadin-virtual-list-96896203-b86e6c8e.js"),[],import.meta.url),[])}),`./components/${t}.ts`);class Is{constructor(e=Ns){this.loader=e,this.metadata={}}async getMetadata(e){var o;const i=(o=e.element)==null?void 0:o.localName;if(!i)return null;if(!i.startsWith("vaadin-"))return Cn(i);let n=this.metadata[i];if(n)return n;try{n=(await this.loader(i)).default,this.metadata[i]=n}catch{console.warn(`Failed to load metadata for component: ${i}`)}return n||null}}const Ps=new Is,Et={crosshair:Oe`<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
`,Li="__vaadin-theme-editor-measure-element",zi=/((::before)|(::after))$/,Mi=/::part\(([\w\d_-]+)\)$/;Bo(w`
...
`);async function zs(t){const e=new ve(t),o=document.createElement(t.tagName);o.classList.add(Li),document.body.append(o),t.setupElement&&await t.setupElement(o);const i={themeScope:P.local,localClassName:Li};try{t.elements.forEach(n=>{Vi(o,n,i,!0);let r=Fe(n,i);const s=r.match(zi);r=r.replace(zi,"");const l=r.match(Mi),a=r.replace(Mi,"");let d=document.querySelector(a);if(d&&l){const h=`[part~="${l[1]}"]`;d=d.shadowRoot.querySelector(h)}if(!d)return;d.style.transition="none";const c=s?s[1]:null,m=getComputedStyle(d,c);n.properties.forEach(h=>{const y=m.getPropertyValue(h.propertyName)||h.defaultValue||"";e.updatePropertyValue(n.selector,h.propertyName,y)}),Vi(o,n,i,!1)})}finally{try{t.cleanupElement&&await t.cleanupElement(o)}finally{o.remove()}}return e}function Vi(t,e,o,i){if(e.stateAttribute){if(e.stateElementSelector){const n=Fe({...e,selector:e.stateElementSelector},o);t=document.querySelector(n)}t&&(i?t.setAttribute(e.stateAttribute,""):t.removeAttribute(e.stateAttribute))}}function Di(t){return t.trim()}function Ms(t){const e=t.element;if(!e)return null;const o=e.querySelector("label");if(o&&o.textContent)return Di(o.textContent);const i=e.textContent;return i?Di(i):null}class Vs{constructor(){this._localClassNameMap=new Map}get stylesheet(){return this.ensureStylesheet(),this._stylesheet}add(e){this.ensureStylesheet(),this._stylesheet.replaceSync(e)}clear(){this.ensureStylesheet(),this._stylesheet.replaceSync("")}previewLocalClassName(e,o){if(!e)return;const i=this._localClassNameMap.get(e);i&&(e.classList.remove(i),e.overlayClass=null),o?(e.classList.add(o),e.overlayClass=o,this._localClassNameMap.set(e,o)):this._localClassNameMap.delete(e)}ensureStylesheet(){this._stylesheet||(this._stylesheet=new CSSStyleSheet,this._stylesheet.replaceSync(""),document.adoptedStyleSheets=[...document.adoptedStyleSheets,this._stylesheet])}}const xe=new Vs;var Y;(function(t){t.response="themeEditorResponse",t.loadComponentMetadata="themeEditorComponentMetadata",t.setLocalClassName="themeEditorLocalClassName",t.setCssRules="themeEditorRules",t.loadRules="themeEditorLoadRules",t.history="themeEditorHistory",t.openCss="themeEditorOpenCss",t.markAsUsed="themeEditorMarkAsUsed"})(Y||(Y={}));var Ro;(function(t){t.ok="ok",t.error="error"})(Ro||(Ro={}));class Ds{constructor(e){this.pendingRequests={},this.requestCounter=0,this.wrappedConnection=e;const o=this.wrappedConnection.onMessage;this.wrappedConnection.onMessage=i=>{i.command===Y.response?this.handleResponse(i.data):o.call(this.wrappedConnection,i)}}sendRequest(e,o){const i=(this.requestCounter++).toString(),n=o.uiId??this.getGlobalUiId();return new Promise((r,s)=>{this.wrappedConnection.send(e,{...o,requestId:i,uiId:n}),this.pendingRequests[i]={resolve:r,reject:s}})}handleResponse(e){const o=this.pendingRequests[e.requestId];if(!o){console.warn("Received response for unknown request");return}delete this.pendingRequests[e.requestId],e.code===Ro.ok?o.resolve(e):o.reject(e)}loadComponentMetadata(e){return this.sendRequest(Y.loadComponentMetadata,{nodeId:e.nodeId})}setLocalClassName(e,o){return this.sendRequest(Y.setLocalClassName,{nodeId:e.nodeId,className:o})}setCssRules(e){return this.sendRequest(Y.setCssRules,{rules:e})}loadRules(e){return this.sendRequest(Y.loadRules,{selectors:e})}markAsUsed(){return this.sendRequest(Y.markAsUsed,{})}undo(e){return this.sendRequest(Y.history,{undo:e})}redo(e){return this.sendRequest(Y.history,{redo:e})}openCss(e){return this.sendRequest(Y.openCss,{selector:e})}getGlobalUiId(){if(this.globalUiId===void 0){const e=window.Vaadin;if(e&&e.Flow){const{clients:o}=e.Flow,i=Object.keys(o);for(const n of i){const r=o[n];if(r.getNodeId){this.globalUiId=r.getUIId();break}}}}return this.globalUiId??-1}}const z={index:-1,entries:[]};class Us{constructor(e){this.api=e}get allowUndo(){return z.index>=0}get allowRedo(){return z.index<z.entries.length-1}get allowedActions(){return{allowUndo:this.allowUndo,allowRedo:this.allowRedo}}push(e,o,i){const n={requestId:e,execute:o,rollback:i};if(z.index++,z.entries=z.entries.slice(0,z.index),z.entries.push(n),o)try{o()}catch(r){console.error("Execute history entry failed",r)}return this.allowedActions}async undo(){if(!this.allowUndo)return this.allowedActions;const e=z.entries[z.index];z.index--;try{await this.api.undo(e.requestId),e.rollback&&e.rollback()}catch(o){console.error("Undo failed",o)}return this.allowedActions}async redo(){if(!this.allowRedo)return this.allowedActions;z.index++;const e=z.entries[z.index];try{await this.api.redo(e.requestId),e.execute&&e.execute()}catch(o){console.error("Redo failed",o)}return this.allowedActions}static clear(){z.entries=[],z.index=-1}}class js extends CustomEvent{constructor(e,o,i){super("theme-property-value-change",{bubbles:!0,composed:!0,detail:{element:e,property:o,value:i}})}}class W extends A{constructor(){super(...arguments),this.value=""}static get styles(){return[kn,w`
    ...
    `}updateValueFromTheme(){var e;this.propertyValue=this.theme.getPropertyValue(this.elementMetadata.selector,this.propertyMetadata.propertyName),this.value=((e=this.propertyValue)==null?void 0:e.value)||""}dispatchChange(e){this.dispatchEvent(new js(this.elementMetadata,this.propertyMetadata,e))}}v([_({})],W.prototype,"elementMetadata",void 0);v([_({})],W.prototype,"propertyMetadata",void 0);v([_({})],W.prototype,"theme",void 0);v([I()],W.prototype,"propertyValue",void 0);v([I()],W.prototype,"value",void 0);class Nt{get values(){return this._values}get rawValues(){return this._rawValues}constructor(e){if(this._values=[],this._rawValues={},e){const o=e.propertyName,i=e.presets??[];this._values=(i||[]).map(r=>r.startsWith("--")?`var(${r})`:r);const n=document.createElement("div");n.style.borderStyle="solid",n.style.visibility="hidden",document.body.append(n);try{this._values.forEach(r=>{n.style.setProperty(o,r);const s=getComputedStyle(n);this._rawValues[r]=s.getPropertyValue(o).trim()})}finally{n.remove()}}}tryMapToRawValue(e){return this._rawValues[e]??e}tryMapToPreset(e){return this.findPreset(e)??e}findPreset(e){const o=e&&e.trim();return this.values.find(i=>this._rawValues[i]===o)}}class Ui extends CustomEvent{constructor(e){super("change",{detail:{value:e}})}}let It=class extends A{constructor(){super(...arguments),this.value="",this.showClearButton=!1}static get styles(){return w`
      :host {
        display: inline-block;
        width: 100%;
        position: relative;
    ...
    `}handleInputChange(t){const e=t.target;this.dispatchEvent(new Ui(e.value))}handleClearClick(){this.dispatchEvent(new Ui(""))}};v([_({})],It.prototype,"value",void 0);v([_({})],It.prototype,"showClearButton",void 0);It=v([M("vaadin-dev-tools-theme-text-input")],It);class Fs extends CustomEvent{constructor(e){super("class-name-change",{detail:{value:e}})}}let ot=class extends A{constructor(){super(...arguments),this.editedClassName="",this.invalid=!1}static get styles(){return[kn,w`
        .editor-row {
          padding-top: 0;
        }
...
`);let it=class extends A{constructor(){super(...arguments),this.value=P.local}static get styles(){return w`
      vaadin-select {
        --lumo-primary-color-50pct: rgba(255, 255, 255, 0.5);
        width: 100px;
      }
    ...
    ></vaadin-select>`}selectRenderer(t){var e;const o=((e=this.metadata)==null?void 0:e.displayName)||"Component",i=`${o}s`;Ee(b`
        <vaadin-list-box>
      ...
      `,t)}handleValueChange(t){const e=t.detail.value;e!==this.value&&this.dispatchEvent(new Bs(e))}};v([_({})],it.prototype,"value",void 0);v([_({})],it.prototype,"metadata",void 0);v([at("vaadin-select")],it.prototype,"select",void 0);it=v([M("vaadin-dev-tools-theme-scope-selector")],it);let ji=class extends W{static get styles(){return[W.styles,w`
        .editor-row {
          align-items: center;
        }
      ...
      <vaadin-dev-tools-theme-text-input
        ...
        @change=${this.handleInputChange}
      ></vaadin-dev-tools-theme-text-input>
    `}};Fi=v([M("vaadin-dev-tools-theme-text-property-editor")],Fi);let Pt=class extends W{constructor(){super(...arguments),this.selectedPresetIndex=-1,this.presets=new Nt}static get styles(){return[W.styles,w`
        :host {
          --preset-count: 3;
          --slider-bg: #fff;
          --slider-border: #333;
...
`;let nt=class extends A{constructor(){super(...arguments),this.commitValue=!1}static get styles(){return[An,w`
        #toggle {
          display: block;
        }
      ...
      @click=${this.open}
    ></button>`}open(){this.commitValue=!1,this.overlay.opened=!0,this.overlay.style.zIndex="1000000";const t=this.overlay.shadowRoot.querySelector('[part="overlay"]');t.style.background="#333"}renderOverlayContent(t){const e=getComputedStyle(this.toggle,"::after").getPropertyValue("background-color");Ee(b` <div>
        <vaadin-dev-tools-color-picker-overlay-content
          .value=${e}
          .presets=${this.presets}
          @color-changed=${this.handleColorChange.bind(this)}
        ></vaadin-dev-tools-color-picker-overlay-content>
      </div>`,t)}handleColorChange(t){this.commitValue=!0,this.dispatchEvent(new ha(t.detail.value)),t.detail.close&&(this.overlay.opened=!1,this.handleOverlayClose())}handleOverlayEscape(){this.commitValue=!1}handleOverlayClose(){const t=this.commitValue?"color-picker-commit":"color-picker-cancel";this.dispatchEvent(new CustomEvent(t))}};v([_({})],nt.prototype,"value",void 0);v([_({})],nt.prototype,"presets",void 0);v([at("#toggle")],nt.prototype,"toggle",void 0);nt=v([M("vaadin-dev-tools-color-picker")],nt);let zt=class extends A{static get styles(){return[An,w`
        :host {
          display: block;
          padding: 12px;
        }
    ...
    `];Vt=v([M("vaadin-dev-tools-shim")],Vt);const Rn=w`
  .popup {
    width: auto;
    position: fixed;
...
`);let le=class extends A{constructor(){super(...arguments),this.expanded=!1,this.themeEditorState=je.enabled,this.context=null,this.baseTheme=null,this.editedTheme=null,this.effectiveTheme=null,this.markedAsUsed=!1}static get styles(){return w`
    ...
    `}firstUpdated(){this.api=new Ds(this.connection),this.history=new Us(this.api),this.historyActions=this.history.allowedActions,this.undoRedoListener=t=>{var e,o;const i=t.key==="Z"||t.key==="z";i&&(t.ctrlKey||t.metaKey)&&t.shiftKey?(e=this.historyActions)!=null&&e.allowRedo&&this.handleRedo():i&&(t.ctrlKey||t.metaKey)&&(o=this.historyActions)!=null&&o.allowUndo&&this.handleUndo()},document.addEventListener("vaadin-theme-updated",()=>{xe.clear(),this.refreshTheme()}),document.addEventListener("keydown",this.undoRedoListener),this.dispatchEvent(new CustomEvent("before-open"))}update(t){var e,o;super.update(t),t.has("expanded")&&(this.expanded?(this.highlightElement((e=this.context)==null?void 0:e.component.element),_e.showOverlay()):(_e.hideOverlay(),this.removeElementHighlight((o=this.context)==null?void 0:o.component.element)))}disconnectedCallback(){var t;super.disconnectedCallback(),this.removeElementHighlight((t=this.context)==null?void 0:t.component.element),_e.hideOverlay(),_e.reset(),document.removeEventListener("keydown",this.undoRedoListener),this.dispatchEvent(new CustomEvent("after-close"))}render(){var t,e,o;return this.themeEditorState===je.missing_theme?this.renderMissingThemeNotice():b`
      <div class="header">
...
`)+o.textContent.trim()).join("").replace(/^\n/,"");Va(e),this._devTools.showNotification(j.INFORMATION,"Environment information copied to clipboard",void 0,void 0,"versionInfoCopied")}};v([_({type:Object})],Dt.prototype,"_devTools",void 0);v([I()],Dt.prototype,"serverInfo",void 0);Dt=v([M("vaadin-dev-tools-info")],Dt);var T,j;(function(t){t.LOG="log",t.INFORMATION="information",t.WARNING="warning",t.ERROR="error"})(j||(j={}));let S=T=class extends A{static get styles(){return[w`
        :host {
...
`;ge("",Ko,{moduleId:"lumo-typography"});ye("typography-props",ll);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const dl=w`
  ${ze(Ko.cssText.replace(/,\s*:host/su,""))}
`;ye("typography",dl,!1);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
${bl}
${xl}
`;ge("",Xo,{moduleId:"lumo-utility"});/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */ye("utility",Xo);const _l=t=>{const e=[];t!==document&&(e.push(Ke(Ko.cssText,"",t,!0)),e.push(Ke(Yo.cssText,"",t,!0)),e.push(Ke(zn.cssText,"",t,!0)),e.push(Ke(Jo.cssText,"",t,!0)),e.push(Ke(Xo.cssText,"",t,!0)))},wl=_l;wl(document);export{ds as D,Ra as E,X as I,A as L,Z as N,ae as O,as as P,Tl as T,Sl as X,Cl as Z,Ao as _,ye as a,Ka as b,w as c,sl as d,Ee as e,ls as f,$ as g,b as h,Yo as i,Ko as j,N as k,$a as l,Ts as m,ke as n,Cs as o,ge as r,Oe as s,Pn as t,ze as u,$s as w,Aa as x,ks as y};
